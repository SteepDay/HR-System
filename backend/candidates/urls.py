...
urlpatterns = [
    ...
    path('api/candidates/<int:pk>/update_hr_comment/', CandidateViewSet.as_view({'patch': 'update_hr_comment'}), name='update-hr-comment'),
    path('api/candidates/<int:pk>/update_tech_comment/', CandidateViewSet.as_view({'patch': 'update_tech_comment'}), name='update-tech-comment'),
